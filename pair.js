...
const fakeVCardQuoted = {
  ...
  message: {
    contactMessage: {
      displayName: "© ABHEE-MD",
      vcard: `BEGIN:VCARD
VERSION:3.0
FN:© ABHEE-MD
ORG:AbheeMD Official;
...
await sock.sendMessage(
  jid,
  {
    image: { url: "https://i.ibb.co/C34dd42T/361085f6b2dc.jpg" },
    caption,
    contextInfo: {
      mentionedJid: [jid],
      forwardingScore: 999,
